...
- **Testable**: 629 automated tests validate data integrity (required fields, valid URLs, no CCP sources)
...
629 tests across 34 files using Vitest + jsdom + React Testing Library.
