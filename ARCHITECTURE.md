...
- **Testable**: 607 automated tests validate data integrity (required fields, valid URLs, no CCP sources)
...
607 tests across 34 files using Vitest + jsdom + React Testing Library.
