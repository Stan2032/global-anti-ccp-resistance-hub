...
- **Testable**: 604 automated tests validate data integrity (required fields, valid URLs, no CCP sources)
...
604 tests across 34 files using Vitest + jsdom + React Testing Library.
