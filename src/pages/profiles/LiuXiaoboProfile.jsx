      ...
      <div className="bg-[#0a0e14] border-b border-[#1c2a35] border-l-2 border-l-yellow-500">
        <div className="max-w-5xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="w-20 h-20 rounded-full bg-[#1c2a35] flex items-center justify-center border-2 border-yellow-500/60">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {activeTab === 'charges' && (
          <div>
            ...
            {/* Formal Charges */}
            {CHARGES.map((c, i) => (
              <div key={i} className="bg-[#111820] border border-[#1c2a35] p-5 mb-4">
            ...
            {/* Liu Xia Section */}
            <div className="mt-6 bg-[#111820] border border-[#1c2a35] p-5">
          ...
          <div>
            ...
            <div className="space-y-3">
              {INTERNATIONAL_RESPONSES.map((r, i) => (
                <div key={i} className="flex items-start gap-3 bg-[#111820] border border-[#1c2a35] p-4">
            ...
            {/* Final Words */}
            <div className="mt-6 bg-[#111820] border border-yellow-700/30 p-5 text-center">
