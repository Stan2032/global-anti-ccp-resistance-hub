    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-4">
        <div>
          ...
          <div className="flex flex-wrap gap-2" role="group" aria-label="Filter sanctions by country">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2" role="group" aria-label="Filter sanctions by type">
