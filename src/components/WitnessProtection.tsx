...
const WitnessProtection = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <DisclosureSection title="Risk Assessment">
          <div className="space-y-4">
            <div className="bg-[#111820]/50 border border-[#1c2a35] p-5">
              ...
              <div className="space-y-4">
                {riskQuestions.map(q => (
                  <div key={q.id} className="bg-[#0a0e14]/50 p-4">
                    ...
                    <div className="flex space-x-3" role="group" aria-label={q.question}>
                      <button
                        onClick={() => setRiskAnswers({...riskAnswers, [q.id]: 'yes'})}
                        aria-pressed={riskAnswers[q.id] === 'yes'}
                      ...
                      <button
                        ...
                        aria-pressed={riskAnswers[q.id] === 'no'}
                        className={`px-4 py-2 text-sm font-medium transition-colors ${
                          riskAnswers[q.id] === 'no'
      ...
      <DisclosureSection title="Immediate Steps">
          <div className="space-y-4">
      ...
      {/* Relocation Section */}
      <DisclosureSection title="Relocation">
          <div className="space-y-4">
            <div className="bg-[#111820]/50 border border-[#1c2a35] p-5">
      ...
      <DisclosureSection title="Legal Protection">
          <div className="space-y-4">
            <div className="bg-[#111820]/50 border border-[#1c2a35] p-5">
      ...
      <DisclosureSection title="Organizations">
          <div className="space-y-4">
            <div className="bg-[#111820]/50 border border-[#1c2a35] p-5">
