...
const CountdownTimer = () => {
  ...
  const importantDates = [
    ...
    },
    {
      ...
      description: `${currentYear - 1995}th anniversary of Gedhun Choekyi Nyima's abduction`,
      Icon: Link2,
      type: 'memorial',
    ...
    },
    {
      ...
      description: `${currentYear - 2020}th anniversary of the National Security Law`,
      Icon: Scale,
      type: 'awareness',
