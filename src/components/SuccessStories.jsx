...
const SuccessStories = () => {
  ...
  const victories = [
    ...
    },
    {
      ...
      category: 'awareness',
      impact: 'CRITICAL',
      description: "Jimmy Lai's trial and conviction drew unprecedented global condemnation from world leaders, UN experts, and press freedom organizations. Sentencing is pending.",
