...
const Glossary = () => {
  ...
  const terms = [
    ...
    },
    {
      ...
      category: 'people',
      definition: 'Hong Kong media mogul sentenced to 20 years on February 9, 2026 under the National Security Law.',
    ...
    <div className="space-y-6">
        ...
        {categories.map(cat => (
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium transition-colors ${
              activeCategory === cat.id ? 'bg-blue-600 text-white' : 'bg-[#111820] text-slate-300 hover:bg-[#111820]'
            }`}
          >
      ...
      <div className="space-y-4">
        {filteredTerms.map((item, index) => (
          <div key={index} className="bg-[#111820]/50 border border-[#1c2a35] p-5">
