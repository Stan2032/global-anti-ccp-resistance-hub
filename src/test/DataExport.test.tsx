...
describe('DataExport', () => {
  ...
  it('shows record counts for datasets', () => {
    render(<DataExport />);
    expect(screen.getByText('65 records')).toBeTruthy(); // prisoners
  ...
  it('selects a dataset when clicked', () => {
    ...
    expect(screen.getByText(/65 total records/)).toBeTruthy();
  });
