...
| [Custom Domain Setup](CUSTOM_DOMAIN_SETUP.md) | Point a custom domain to Cloudflare Workers. Enables Onion Routing for Tor access. | Domain registrar account, Cloudflare account |
